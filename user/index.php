...
if ($result->num_rows > 0) {
    ...
    // Handle kasus jika tidak ada data yang ditemukan untuk username tersebut
    ...
    <div class="dashboard-main-wrapper">
      ...
      <div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
          <br />
          <img src="../assets/images/logo-user.png" alt="Logo E-Itesa" style="width: 360px; height: 68px; margin-left: 30px" />
                                  ...
                                  <div class="card-body">
                                      <form id="form" data-parsley-validate="" novalidate="">
                                          <div class="form-group row">
                                              <label for="inputName" class="col-3 col-lg-2 col-form-label text-right">Name</label>
                                              <div class="col-9 col-lg-10">
                                                  <input id="inputName" type="text" required="" placeholder="Name" class="form-control" 
                                                        value="<?php echo $name; ?>"> </div>
                                          </div>

                                          <div class="form-group row">
                                              <label for="inputClass" class="col-3 col-lg-2 col-form-label text-right">Class</label>
                                              <div class="col-9 col-lg-10">
                                                  <input id="inputClass" type="text" required="" placeholder="Class" class="form-control"
                                                        value="<?php echo $class; ?>"> </div>
                                          </div>

                                          <div class="form-group row">
                                              <label for="inputTelp" class="col-3 col-lg-2 col-form-label text-right">Telp</label>
                                              <div class="col-9 col-lg-10">
                                                  <input id="inputTelp" type="tel" required="" placeholder="Telp" class="form-control"
                                                        value="<?php echo $telp; ?>"> </div>
                                          </div>
